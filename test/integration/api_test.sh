...
# Usage: SERVER=http://101.34.212.20:8080 PASSWORD=agentlink123 bash api_test.sh

set -uo pipefail

SERVER="${SERVER:-http://101.34.212.20:8080}"
PASSWORD="${PASSWORD:-agentlink123}"
PASS=0
FAIL=0
...
cleanup() {
  ...
  ssh 101.34.212.20 "redis-cli KEYS 'agentlink:*'" 2>/dev/null | \
